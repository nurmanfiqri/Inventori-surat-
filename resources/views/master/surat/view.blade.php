            ...
            <form class="form-horizontal" action="{{url()->current()}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body col-sm-10">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="surat" name="nama" value="{{isset($model) ? $model->nama : ''}}" placeholder="Contoh: Surat Undangan Acara ..." readonly>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input class="form-control" value="{{isset($model) &&  $model->workflow ? $model->workflow->nama_workflow : ''}}" readonly/>
                  </div>
                {{-- <div class="form-group row">
