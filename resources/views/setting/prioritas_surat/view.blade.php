            ...
            <div class="card-body">
              <div class="form-group row">
                <div class="col-lg-6">
                  ...
                  <input type="text" class="form-control" placeholder="Jenis Surat" name="jenis_surat" value="{{isset($model) ? $model->prioritas_surat : ''}}" disabled/>
                  {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                </div>
                <div class="col-lg-6">
                  <label>Kode Label</label>
                  <input type="text" class="form-control" placeholder="Kode Label" name="kode" value="{{isset($model) ? $model->kode : ''}}" disabled/>
              ...
              <div class="form-group row">
                <div class="col-lg-6">
                  ...
                  <div class="input-group">
                    <input type="color" class="form-control" id="color" name="warna" placeholder="Pilih Warna" value="{{isset($model) ? $model->warna : ''}}" disabled/>
                ...
                <div class="col-lg-6">
                  <label>Preview</label>
                  <div class="input-group">
                    <label id="preview" class="badge text-white mt-2" style="{{isset($model) ? 'background-color:'.$model->warna : ''}}">{{isset($model->warna) ? $model->kode : ''}}</label>
                  </div>
