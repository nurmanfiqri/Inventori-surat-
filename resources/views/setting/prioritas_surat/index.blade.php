              ...
              <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">  
                  ...
                  <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{url('setting/prioritas-surat/create')}}" class="btn btn-primary font-weight-bolder">
...
<script>
    ...
    function load_data(){
        $('#kt_datatable').DataTable({
            ...
            scrollX: true,
            ajax:{
                url: '{{url("api/setting/prioritas_surat")}}',
                type: 'GET',
                dataType: 'JSON',
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'prioritas_surat', name: 'prioritas_surat'},
                {data: 'kode', name: 'kode'},
