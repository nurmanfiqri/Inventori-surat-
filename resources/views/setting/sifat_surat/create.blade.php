            ...
            <div class="card-body">
              <div class="form-group row">
                <div class="col-lg-6">
                  ...
                  <input type="text" class="form-control" placeholder="Sifat Surat" name="sifat_surat" value="{{isset($model) ? $model->sifat_surat : ''}}" required/>
                  {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                </div>
                <div class="col-lg-6">
                  <label>Kode Label</label>
                  <input type="text" class="form-control" placeholder="Kode Label" id="kode" name="kode" value="{{isset($model) ? $model->kode : ''}}" required/>
              ...
              <div class="form-group row">
                <div class="col-lg-6">
                  ...
                  <div class="input-group">
                    <input type="color" class="form-control" id="color" name="warna" placeholder="Pilih Warna" value="{{isset($model) ? $model->warna : ''}}" required/>
