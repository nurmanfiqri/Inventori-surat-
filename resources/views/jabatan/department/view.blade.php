          ...
          <form class="form" action="{{url()->current()}}" method="POST">
            ...
            <div class="card-body">
              <div class="form-group row">
                <div class="col-lg-6">
                  <label>Jabatan</label>
                  <input type="text" class="form-control" placeholder="Department" name="department" value="{{isset($model) ? $model->department : ''}}" disabled/>
                  {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                </div>
                <div class="col-lg-6">
                    <label>Akses</label>
                    <input type="text" class="form-control" placeholder="Singkatan" name="singkatan" value="{{isset($model) ? $model->singkatan : ''}}" disabled/>
                    {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                  </div>
              </div>
            </div>
