            ...
            <div class="card-body">
              <div class="form-group row">
                <div class="col-lg-6">
                  ...
                  <input type="text" class="form-control" placeholder="Department" name="department" value="{{isset($model) ? $model->department : ''}}" required/>
                  {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                </div>
                <div class="col-lg-6">
                    <label>Singkatan</label>
                    <input type="text" class="form-control" placeholder="Singkatan" name="singkatan" value="{{isset($model) ? $model->singkatan : ''}}" required/>
                    {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                  </div>
              </div>
            </div>
