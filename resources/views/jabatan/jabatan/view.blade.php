          ...
          <form class="form" action="{{url()->current()}}" method="POST">
            ...
            <div class="card-body">
              <div class="form-group row">
                <div class="col-lg-6">
                  <label>Jabatan</label>
                  <input type="text" class="form-control" placeholder="Jabatan" name="nama_divisi" value="{{isset($model) ? $model->nama_divisi : ''}}" disabled/>
                  {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                </div>
                <div class="col-lg-6">
                    <label>Akses</label>
                    <input type="text" class="form-control" placeholder="Jabatan" name="nama_divisi" value="{{isset($model) ? $model->AksesRole->role : ''}}" disabled/>
                    {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                  </div>
              </div>
            </div>
